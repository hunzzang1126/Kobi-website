  ...
  return (
    <section id="gallery" className={styles.gallerySection} ref={sectionRef}>
      ...
      <div className={styles.header}>
        ...
        <span className={`${styles.label} reveal`}>The Experience</span>
        <h2 className={`${styles.heading} reveal`}>Fire & Atmosphere</h2>
      </div>
      ...
      <div className={`${styles.scrollHint} reveal`} aria-hidden="true">
        ...
        <span className={styles.hintText}>Drag to explore</span>
        <span className={styles.hintLine} />
      </div>
    </section>
  );
